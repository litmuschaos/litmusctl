...
func GetAgentDetails(mode string, pid string, t util.Token, cred util.Credentials, kubeconfig *string) util.Agent {
...
AGENT_NAME:
	...
	// Get namespace
	newAgent.Namespace, newAgent.NsExists = k8s.ValidNs(mode, constants.ChaosAgentLabel, kubeconfig)
